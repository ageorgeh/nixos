...

{
  ...
  services.kanata = {
    ...
    keyboards = {
    "magicKeyboard" = {
    devices = ["/dev/input/by-id/usb-Apple_Inc._Magic_Keyboard_with_Touch_ID_and_Numeric_Keypad_F0T3076RRVC0XXQAM-if01-event-kbd"];
config = ''
    ...
    '';
      ...
      "annePro" = {
        ...
        devices = ["/dev/input/by-id/usb-OBINS_OBINS_AnnePro2_00000000000000000000000000000000-event-kbd"];
        extraDefCfg = ''
        '';
        config = ''
