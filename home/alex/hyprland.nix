    ...
    settings =
      {
        ...
        bind =
          [
            ...
            "$mod SHIFT, K, hy3:movewindow, d"
            "$mod SHIFT, I, hy3:movewindow, u"
            "$mod SHIFT, J, hy3:movewindow, l"
            "$mod, L, hy3:movefocus, r, visible"
            "$mod, K, hy3:movefocus, d, visible"
            "$mod, I, hy3:movefocus, u, visible"
            "$mod, J, hy3:movefocus, l, visible"
